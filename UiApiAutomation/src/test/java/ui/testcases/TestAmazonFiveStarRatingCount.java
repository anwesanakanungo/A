...
public class TestAmazonFiveStarRatingCount {
    private static final Logger logger = LoggerFactory.getLogger(TestAmazonFiveStarRatingCount.class);
    ...
    @Test
    public void TestFiveStarRatingCountFirstPage() throws InterruptedException {
        ...
        assertThat(numberofStarRating).isLessThan(5);
        logger.info("verify 5 star rating less than 5");

    }

    @Test
    public void TestFiveStarRatingCountSecondPage() throws InterruptedException {
        GoogleSearchPage.using(driver)
                .goToGoogle()
                .setSearchText("amazon")
                .goToAmazon();
        ...
        List<WebElement> allfivestarRatingFirstPage = DellComputerPage.allsStarRatingProduct;
        int numberofStarRating = allfivestarRatingFirstPage.size();
        assertThat(numberofStarRating).isGreaterThanOrEqualTo(0);
